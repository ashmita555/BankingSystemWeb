...
<body>
	...
	<form action="FundsTransferServlet"
		method="post">
		<table cellspacing="10" cellpadding="10" align="center">
			<tr>
				<td><b>Recepient Account Number:</b></td>
				<td><input type="text" name="accountNoTo" pattern="[1-9][0-9]{8}" required></td>
			</tr>
			<tr>
				<td><b>Amount to be transfered:</b></td>
				<td><input type="text" name="transferAmount" pattern="[1-9][0-9]{0,}"
					required></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center"><input type="submit"
					value="Transfer Funds" class="button"></td>
			</tr>
		</table>
	</form>
	<br>
